...
// ---- Slave Communication (I_SlaveComm.ino) ----
void initSlaveComm();
bool slavePing();
...
void setup() {
    ...
    // Slave Arduino Mega Communication
    // initSlaveComm() akan mencoba PING ke Slave.
...
void loop() {
    ...
    // Update komunikasi Slave (baca ACK, periodic ping)
    updateSlaveComm();
